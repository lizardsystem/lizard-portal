...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ConfigurationToValidate.user_name'
        db.delete_column('lizard_portal_configurationtovalidate', 'user_name')


    def backwards(self, orm):
        
        # Adding field 'ConfigurationToValidate.user_name'
        db.add_column('lizard_portal_configurationtovalidate', 'user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=48), keep_default=False)
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 12, 5, 45, 47, 823881)'}),
