...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConfigurationToValidate.fews_meta_info'
        db.alter_column('lizard_portal_configurationtovalidate', 'fews_meta_info', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Changing field 'ConfigurationToValidate.fews_meta_info'
        db.alter_column('lizard_portal_configurationtovalidate', 'fews_meta_info', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 28, 8, 17, 4, 606811)'}),
