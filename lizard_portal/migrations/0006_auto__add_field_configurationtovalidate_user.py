...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConfigurationToValidate.user'
        db.add_column('lizard_portal_configurationtovalidate', 'user', self.gf('django.db.models.fields.CharField')(default='', max_length=48), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConfigurationToValidate.user'
        db.delete_column('lizard_portal_configurationtovalidate', 'user')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 12, 5, 46, 47, 355125)'}),
