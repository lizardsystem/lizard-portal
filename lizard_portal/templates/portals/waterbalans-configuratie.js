		...
		items: [{
            ...
            items:[{
                ...
                dataConfig:[
                    ...
                    {name: 'bottom_init_water_level', title: 'bottom_init_water_level', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'bottom_max_water_level', title: 'bottom_max_water_level', editable: true, visible: true, width: 100, type: 'number'},
                    ...
                    {name: 'drainage_fraction', title: 'drainage_fraction', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'incr_concentr_nitrogen_drainage_indraft', title: 'incr_concentr_nitrogen_drainage_indraft', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'incr_concentr_nitrogen_flow_off', title: 'incr_concentr_nitrogen_flow_off', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'incr_concentr_phosphate_drainage_indraft', title: 'incr_concentr_phosphate_drainage_indraft', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'incr_concentr_phosphate_flow_off', title: 'incr_concentr_phosphate_flow_off', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'indraft_fraction', title: 'indraft_fraction', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'init_water_level', title: 'init_water_level', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'is_computed', title: 'is_computed', editable: true, visible: true, width: 100, type: 'boolean'},
                    {name: 'kwelwegz', title: 'kwelwegz', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'kwelwegz_is_ts', title: 'kwelwegz_is_ts', editable: true, visible: true, width: 100, type: 'timeserie'},
                    {name: 'label_drainaige_indraft', title: 'label_drainaige_indraft', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'label_flow_off', title: 'label_flow_off', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'man_water_level', title: 'man_water_level', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'min_concentr_nitrogen_drainage_indraft', title: 'min_concentr_nitrogen_drainage_indraft', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'min_concentr_nitrogen_flow_off', title: 'min_concentr_nitrogen_flow_off', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'min_concentr_phosphate_drainage_indraft', title: 'min_concentr_phosphate_drainage_indraft', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'min_concentr_phosphate_flow_off', title: 'min_concentr_phosphate_flow_off', editable: true, visible: true, width: 100, type: 'number'},
                ...
                dataConfig:[
                    {name: 'name', title: 'name', editable: true, visible: true, width: 100, type: 'text'},
                    {name: 'code', title: 'code', editable: true, visible: true, width: 100, type: 'text'},
                    {name: 'in_out', title: 'in_out', editable: true, visible: true, width: 100, type: 'boolean'},
                    {name: 'area', title: 'area', editable: true, visible: true, width: 100, type: 'text'},
                    {name: 'concentr_chloride', title: 'concentr_chloride', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'deb_is_ts', title: 'deb_is_ts', editable: true, visible: true, width: 100, type: 'boolean'},
                    {name: 'deb_wint', title: 'deb_wint', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'deb_zomer', title: 'deb_zomer', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'id', title: 'id', editable: true, visible: true, width: 100, type: 'text'},
                    {name: 'incr_concentr_nitrogen', title: 'incr_concentr_nitrogen', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'incr_concentr_phosphate', title: 'incr_concentr_phosphate', editable: true, visible: true, width: 100, type: 'number'},
                    {name: 'is_computed', title: 'is_computed', editable: true, visible: true, width: 100, type: 'boolean'},
