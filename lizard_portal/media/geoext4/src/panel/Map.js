...
Ext.define('GeoExt.panel.Map', {
	 ...
	 *  ``Dict(String)`` dict with creation options
	 */
	...
	initComponent : function() {
        ...
        MapClickControl = OpenLayers.Class(OpenLayers.Control, {
            ...
            trigger: function (e) {
                var lonlat;
                lonlat = me.map.getLonLatFromViewPortPx(e.xy);
                me.onMapClick(e,lonlat);
        ...
        this.map.addControl(map_click_control);
    ...
    ZoomSlider: function(options) {
        control = new OpenLayers.Control.PanZoomBar(options);
