(function() {
  ...
  Ext.application({
    name: 'lizardViewer',
    models: ['Vss.model.Communique', 'Vss.model.Esf', 'Vss.model.Maplayer', 'Vss.model.ObjectTree'],
    stores: ['Vss.store.Communique', 'Vss.store.Esf', 'Vss.store.Maplayer', 'Vss.store.CatchmentTree', 'Vss.store.KrwGebiedenTree'],
