...
(function() {
  ...
  Ext.define('Lizard.window.MapWindow', {
    ...
    deserialize: function(features_string) {
      var bounds, elem, feature, features, final_features, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4;
      ...
      if (features) {
        ...
        for (_i = 0, _len = features.length; _i < _len; _i++) {
          ...
          if ((_ref = feature.geometry.CLASS_NAME) === 'OpenLayers.Geometry.MultiPoint' || _ref === 'OpenLayers.Geometry.MultiLineString' || _ref === 'OpenLayers.Geometry.MultiPolygon') {
            _ref1 = feature.geometry.components;
        ...
        if (!this.active_edit_layer) {
          if ((_ref2 = this.geometry_type) === 'OpenLayers.Geometry.Point' || _ref2 === 'OpenLayers.Geometry.MultiPoint') {
            this.active_edit_layer = this.points;
          } else if ((_ref3 = this.geometry_type) === 'OpenLayers.Geometry.LineString' || _ref3 === 'OpenLayers.Geometry.MultiLineString') {
            this.active_edit_layer = this.lines;
          } else if ((_ref4 = this.geometry_type) === 'OpenLayers.Geometry.Polygon' || _ref4 === 'OpenLayers.Geometry.MultiPolygon') {
...
=======
            ...
            handler: function() {
              if (me.active_editor.undo) {
                return me.active_editor.undo();
              }
            }
          }, {
            xtype: 'button',
>>>>>>> 91cedef6e75f9e14a6a0857739ab7033ff0f0726
            text: 'Verwijder',
            handler: function() {
              var feature;
