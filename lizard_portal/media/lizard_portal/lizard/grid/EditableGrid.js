...
(function() {
  ...
  Ext.define('Lizard.grid.EditableGrid', {
    ...
    getColumnConfig: function() {
      var col, colConfig, col_sub, cols, cols_with_header, getColconfig, me, _i, _j, _len, _len1, _ref, _ref1;
      me = this;
          ...
          if (this.msgDeleteSelectedRecord) {
            ...
            return Ext.Msg.show({
              ...
              fn: function(buttonId, text, opt) {
                if (buttonId === 'yes') {
                  return me.store.remove(selection);
                }
              }
            });
          } else {
    ...
    getStoreConfig: function() {
      var field, fields, getGridFieldSettings, params, proxyparams, store, subfield, url, _i, _j, _len, _len1, _ref, _ref1;
      fields = [];
